  ...
  return (
    <div>
      <h1 className="text-2xl md:text-3xl font-bold text-[#FFF8E7] mb-6">
        Кто вы в эти майские?
      </h1>
      <p className="text-lg text-[#FFF8E7] mb-8">
        Майские праздники - время тепла, уюта и вкусных шашлыков! Пройдите простой квиз и узнайте, кто вы в эти майские праздники. С нас - подарок! 💗
      </p>
      <button
        onClick={startQuiz}
